...
for i=1:trainsize
    ...
    motionrand = unidrnd(4);
    if typerand == 1
        nrand = unidrnd(4);
        rawdata = motions((motionrand - 1) * 5 + nrand);
    elseif typerand == 2
        rawdata = still1;
    end
...
csvwrite('./ML_data/train_label_2.csv', name);
dlmwrite('./ML_data/train_label_2.csv', train_label, '-append');
csvwrite('./ML_data/train_phase_2.csv', name);
dlmwrite('./ML_data/train_phase_2.csv', train_phasedata, '-append');
csvwrite('./ML_data/train_rssi_2.csv', name);
dlmwrite('./ML_data/train_rssi_2.csv', train_rssidata, '-append');
csvwrite('./ML_data/train_distance_2.csv', name);
dlmwrite('./ML_data/train_distance_2.csv', train_distancedata, '-append');
...
csvwrite('./ML_data/test_label_2.csv', name);
dlmwrite('./ML_data/test_label_2.csv', test_label, '-append');
csvwrite('./ML_data/test_phase_2.csv', name);
dlmwrite('./ML_data/test_phase_2.csv', test_phasedata, '-append');
csvwrite('./ML_data/test_rssi_2.csv', name);
dlmwrite('./ML_data/test_rssi_2.csv', test_rssidata, '-append');
csvwrite('./ML_data/test_distance_2.csv', name);
dlmwrite('./ML_data/test_distance_2.csv', test_distancedata, '-append');
