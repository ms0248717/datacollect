...
for j in range(1 ,11):
    ...
    phase = read_data('../reader_data/ML_realdata/phase_line_0_50_' + str(j) + '.csv')
    rssi = read_data('../reader_data/ML_realdata/rssi_line_0_50_' + str(j) + '.csv')
    distance = read_data('../reader_data/ML_realdata/distance_line_0_50_' + str(j) + '.csv')
    ...
    model = load_model('./bestmodel/C5_d1.h5')
