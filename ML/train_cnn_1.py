...
model_m.add(Conv1D(150, 20, activation='relu', input_shape=(num_time_periods, num_sensors)))
model_m.add(Conv1D(150, 20, activation='relu'))
model_m.add(MaxPooling1D(3))
model_m.add(Conv1D(170, 10, activation='relu'))
model_m.add(Conv1D(170, 10, activation='relu'))
