...
traindistance = read_data('../ML_data/train_distance_2.csv')
...
testdistance = read_data('../ML_data/test_distance_2.csv')
...
X_traindistance = feature_normalize_r(X_traindistance)
X_testphase = feature_normalize_p(X_testphase)
X_testrssi = feature_normalize_r(X_testrssi)
X_testdistance = feature_normalize_r(X_testdistance)
#print(Y_train.shape)
