...
for j in range(1 ,21):
    ...
    phase = read_data('../reader_data/ML_realdata/phase_square_0_50_' + str(j) + '.csv')
    rssi = read_data('../reader_data/ML_realdata/rssi_square_0_50_' + str(j) + '.csv')
    ...
    model = load_model('./bestmodel/C5_1_15_25_sn.h5')
