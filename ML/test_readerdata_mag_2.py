...
for lab in range(0,5):
    ...
    for j in range(1 ,21):
        ...
        phase = read_data('../reader_data/ML_realdata/magtag/phase_mag_' + LABELS[lab] + '_1_' + str(j) + '.csv')
        rssi = read_data('../reader_data/ML_realdata/magtag/rssi_mag_' + LABELS[lab] + '_1_' + str(j) + '.csv')
