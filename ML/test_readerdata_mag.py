...
for lab in range(0, 4):
    ...
    for j in range(1, 21):
        ...
        rssi = read_data('../reader_data/ML_realdata/magtag/rssi_mag_' +
                         LABELS[lab] + '_' + str(outputN) + '_' + str(j) + '.csv')
        distance = read_data('../reader_data/ML_realdata/magtag/distance_mag_' +
                             LABELS[lab] + '_' + str(outputN) + '_' + str(j) + '.csv')
