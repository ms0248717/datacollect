...
for lab in range(0,4):
    ...
    for j in range(1 ,21):
        ...
        rssi = read_data('../reader_data/ML_realdata/magtag/rssi_mag_' + LABELS[lab] + '_' + str(outputN) + '_' + str(j) + '.csv')
        distance = read_data('../reader_data/ML_realdata/magtag/distance_mag_' + LABELS[lab] + '_' + str(outputN) + '_' + str(j) + '.csv')
...
print("Acc: ", ACC / 80.0)
print("line: ",mACC[0] / 20.0)
print("shake: ",mACC[1] / 20.0)
print("square: ",mACC[2] / 20.0)
print("circle: ",mACC[3] / 20.0)
