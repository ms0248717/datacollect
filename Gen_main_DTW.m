...
csvwrite('./ML_data/train_label_DTW.csv', name);
dlmwrite('./ML_data/train_label_DTW.csv', train_label, '-append');
csvwrite('./ML_data/train_phase_DTW.csv', name);
dlmwrite('./ML_data/train_phase_DTW.csv', train_phasedata, '-append');
csvwrite('./ML_data/train_rssi_DTW.csv', name);
dlmwrite('./ML_data/train_rssi_DTW.csv', train_rssidata, '-append');
