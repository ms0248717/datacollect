...
for lab = 1:5
    for num = 1:10
        rawdata = readtable(['./gc_tagsize_data/', char(LABELS(lab)),'_h1o1_2_', num2str(num),'.csv']);
        outputphase = ['./ML_realdata/gc_tagsize/phase_', char(LABELS(lab)),'_h1o1_2_5_', num2str(num), '.csv'];
        outputrssi = ['./ML_realdata/gc_tagsize/rssi_', char(LABELS(lab)),'_h1o1_2_5_', num2str(num), '.csv'];
        outputdistance = ['./ML_realdata/gc_tagsize/distance_', char(LABELS(lab)),'_h1o1_2_5_', num2str(num), '.csv'];
