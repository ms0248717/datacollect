...
for lab = 1:5
    for num = 1:20
        rawdata = readtable(['./mag_gc_data/mag_', char(LABELS(lab)),'_', num2str(num), '.csv']);
        outputphase = ['./ML_realdata/magtag/phase_mag_', char(LABELS(lab)),'_1_', num2str(num), '.csv'];
        outputrssi = ['./ML_realdata/magtag/rssi_mag_', char(LABELS(lab)),'_1_', num2str(num), '.csv'];
        outputdistance = ['./ML_realdata/magtag/distance_mag_', char(LABELS(lab)),'_1_', num2str(num), '.csv'];
