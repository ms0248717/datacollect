...
for lab = 1:5
    for dis = 1:3
        for num = 1:20
            rawdata = readtable(['./data/', char(LABELS(lab)),'_0_',num2str(DIS(dis)),'_', num2str(num), '.csv']);
            outputphase = ['./ML_realdata/phase_', char(LABELS(lab)),'_0_',num2str(DIS(dis)),'_', num2str(num), '.csv'];
            outputrssi = ['./ML_realdata/rssi_', char(LABELS(lab)),'_0_',num2str(DIS(dis)),'_', num2str(num), '.csv'];
            outputdistance = ['./ML_realdata/distance_', char(LABELS(lab)),'_0_',num2str(DIS(dis)),'_', num2str(num), '.csv'];
